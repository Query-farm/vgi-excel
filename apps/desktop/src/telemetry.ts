...
const DEFAULT_DSN = "https://f366da21a171a3e200d0a82f2af81e14@o4511299556081664.ingest.us.sentry.io/4511948913049600";
...
export function initializeTelemetry(): void {
  ...
  Sentry.init({
    dsn: import.meta.env.VITE_SENTRY_DESKTOP_DSN || DEFAULT_DSN,
    enabled,
    ...
    initialScope: {
      tags: { product: "cupola-excel", host: "desktop-workbench", version: __APP_VERSION__, build: __BUILD_ID__, transport: "https" },
    },
  });
}
